...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 py-5 my-1" data-aos="zoom-in" data-aos-delay="400">
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Nitinjr812" },
  { icon: Linkedin, link: "///////" },
  { icon: Instagram, link: "https://www.instagram.com/way2nitinn/" }
];
